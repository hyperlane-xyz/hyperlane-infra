...
locals {
  validator_roles   = [for i in range(var.validator_count) : format("khalani-hyperlane-validator-%d", i)]
  validator_keys    = [for i in range(var.validator_count) : format("alias/khalani-hyperlane-validator-signer-%d", i)]
  validator_buckets = [for i in range(var.validator_count) : format("khalani-validator-signatures-%d", i)]
}
